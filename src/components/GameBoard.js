...
import { GAME_STATE_DRAW, GAME_STATE_PLAYING, GAME_STATE_WIN, NO_CIRCLES, NO_PLAYER, PLAYER_1, PLAYER_2 } from "./constants";
...
const GameBoard = () => {
  ...
  return (
    <>
      ...
      <Footer onNewGameClick={initGame} onSuggestClick={suggestClick} gameState={gameState} />
    </>
  )
}
